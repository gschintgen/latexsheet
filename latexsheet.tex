...
N.B. In the digital version of this cheat sheet all package names link to their
...
package \texttt{ragged2e} and its environments \verb!RaggedRight!,
\verb!RaggedLeft!, and \verb!Center!.
