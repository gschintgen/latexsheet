...
\usepackage{comment}
\excludecomment{sec-biblio}
\excludecomment{subsec-accents}
...
\verb!article! & Best suited for exercise sheets.\\%No \verb!\part! or \verb!\chapter! divisions. \\
% \verb!letter!  & Letter (?). \\
...
N.B. In the PDF version of this cheat sheet all package names link to their
respective CTAN page for quick access to the full documentation.
\settowidth{\MyLen}{\texttt{tkz-euclide} }
\begin{tabular}{@{}p{\the\MyLen}%
                @{}p{\linewidth-\the\MyLen}@{}}
\href{https://ctan.org/pkg/babel}{\texttt{babel}}
        & Support for non-English languages.\newline
        See below for French typesetting.\\
\href{https://ctan.org/pkg/geometry}{\texttt{geometry}}
        &  Page layout (margins, etc.)\\
\href{https://ctan.org/pkg/multicol}{\texttt{multicol}}
        & Use $n$ columns: \verb!\begin{multicols}{!$n$\verb!}!.   \\
\href{https://ctan.org/pkg/fancyhdr}{\texttt{fancyhdr}}
        &  Customize header and footer\\
\href{https://ctan.org/pkg/mathtools}{\texttt{mathtools}}
        &  Advanced math typesetting. Includes \texttt{amsmath}.\\
...
\href{https://ctan.org/pkg/hyperref}{\texttt{hyperref}}
        & Insert URL: \verb!\url{!%
        \textit{https://\ldots}%
        \verb!}!\newline or hyperlink: \verb!\href{URL}{text}!.\\
\href{https://ctan.org/pkg/enumitem}{\texttt{enumitem}}
        & Customize \verb!enumerate!.\\
\href{https://ctan.org/pkg/tabularx}{\texttt{tabularx}}
        & Stretchable \texttt{X} columns in tables.\\
\href{https://ctan.org/pkg/tabulary}{\texttt{tabulary}}
        & Automatically balanced column widths.\\
\href{https://www.ctan.org/pkg/tabto-ltx}{\texttt{tabto}}
        & Tab stops (compatible with enumerations).\\
\href{https://www.ctan.org/pkg/pgf}{\texttt{tikz}}
        & \textbf{T}ikZ \textbf{i}st \textbf{k}ein
        \textbf{Z}eichenprogramm.\newline
        Make beautiful and precise scientific drawings.\newline
        Full online documentation:
        \url{https://tikz.dev}\\
\href{https://ctan.org/pkg/tkz-euclide}{\texttt{tkz-euclide}}
        & Tools for drawing Euclidean geometry; based on TikZ/PGF.\\
\href{https://ctan.org/pkg/tkz-tab}{\texttt{tkz-tab}}
        & Tableaux de variations / signes.\\
\href{https://www.ctan.org/pkg/pgfplots}{\texttt{pgfplots}}
        & Create various high-quality plots; based on TikZ/PGF.\\
\href{https://www.ctan.org/pkg/beamer}{\texttt{beamer}}
        & For creating slides.
\end{tabular}
...
\begin{tabular}{@{}p{\the\MyLen}%
                @{}p{\linewidth-\the\MyLen}@{}}
\verb!\begin{comment}!    &  Comment (not printed).\newline
        Requires \texttt{verbatim} package. \\
...
Better typesetting (by enabling hyphenation) can be achieved using the
package \href{https://ctan.org/pkg/ragged2e}{\texttt{ragged2e}} and its
environments \verb!RaggedRight!, \verb!RaggedLeft!, and \verb!Center!.
...
% babel's \DecimalMathComma is definitely worse
% than icomma.
% 1,23\quad $1,23$\\
% (4, 5)\quad $(4, 5)$\\
% (6,x)\quad $(6,x)$\\
...
Use \href{https://ctan.org/pkg/babel-french}{babel-french}:
\selectlanguage{french}
\begin{verbatim}
...
\begin{tabular}{@{}l@{\hspace{1ex}}l@{\hspace{2em}}l@{\hspace{1ex}}l%
        @{\hspace{2em}}l@{\hspace{1ex}}l@{\hspace{1em}}l@{\hspace{1ex}}l@{}}
1\ier           &  \verb!1\ier!  &
1\iers          &  \verb!1\iers!  &
1\iere          &  \verb!1\iere!  &
1\ieres         &  \verb!1\ieres!  \\
2\ieme          &  \verb!2\ieme!  &
2\iemes         &  \verb!2\iemes!  &
M\up{me}        &  \verb!M\up{me}!  &
D\up{r}         &  \verb!D\up{r}!  \\
\oe             &  \verb!\oe!  &
\OE             &  \verb!\OE!  &
\ae             &  \verb!\ae!  &
...
\og{}           &  \verb!\og{}!  &
\fg{}           &  \verb!\fg{}!  &
\frquote{Oh!}   &  \verb|\frquote{Oh!}|
\end{tabular}

\selectlanguage{english}
\href{https://ctan.org/pkg/polyglossia}{Polyglossia} is a modern replacement for
\texttt{babel}, but it's only compatible with XeLaTeX and LuaLaTeX.
...
\settowidth{\MyLen}{\texttt{.columnbreak} }
\begin{tabular}{@{}p{\the\MyLen}%
                @{}p{\linewidth-\the\MyLen}@{}}
...
\verb!\columnbreak!  &  Start new column. \\
\verb!\noindent!   &  Do not indent current line.
\end{tabular}


\subsection{Spaces and rules}
\settowidth{\MyLen}{\texttt{.rule.w..h.} }
\begin{tabular}{@{}p{\the\MyLen}%
                @{}p{\linewidth-\the\MyLen}@{}}
\verb!~!       &  Fixed space, disallow linebreak (\verb!N.~Biever!). \\
\verb!\smallskip!       &  Small vertical space. \\
\verb!\medskip!       &  Medium vertical space. \\
\verb!\bigskip!       &  Big vertical space. \\
...
Rules of width/height 0 are sometimes useful for solving spacing or alignment
issues.

\section{Tables and tab stops}

\subsection{Tab stops: \texttt{tabbing} vs. \texttt{tabto}}
...
\medskip
The \texttt{tabbing} environment is incompatible with
\texttt{enumerate}/\texttt{itemize}. In this case it's better to use the package
\texttt{tabto} instead:
\begin{verbatim}
...
\verb!\vec{u}!      &  
$\overrightarrow{AB}$         &
\verb!\overrightarrow{AB}!    \\ 
\end{tabular}

\subsection{Vectors, matrices, and determinants}
...
\end{minipage}
&
$\begin{pmatrix}1&2\\3&4\end{pmatrix}$\\[3ex]
\begin{minipage}[m]{\linewidth}
\begin{verbatim}
\begin{vmatrix}
1&2\\   3&4
...
\verbatiminput{sampledoc.tex}


\section{Online tools}

Detexify: \url{https://detexify.kirelabs.org/}

Table generator: \url{https://www.tablesgenerator.com/latex_tables}
...
Copyright \copyright\ 2025 Gilles Schintgen

\url{https://wch.github.io/latexsheet/}\\
\url{https://gschintgen.github.io/latexsheet/}
